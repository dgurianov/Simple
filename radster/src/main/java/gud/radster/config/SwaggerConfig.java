...
public class SwaggerConfig {
    ...
    public Docket getTemplateApis() {
        ...
        final String docDescription = "This is radster api";
        final String pathRegexp = "(/radster).+";
        return buildD("radster", PathSelectors.regex(pathRegexp), docTitle, docDescription);
    }
